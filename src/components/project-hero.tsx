...
import { ProjectInviteShare } from "@/components/project-invite-share";
    ...
    <section className="mb-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-col items-end gap-3 sm:flex-row sm:items-center">
          <span className="rounded-full bg-slate-100 px-3 py-2 text-sm text-muted">邀请码：{project.inviteCode}</span>
          <ProjectInviteShare inviteCode={project.inviteCode} />
        </div>
      </div>
